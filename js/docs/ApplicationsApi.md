...
[**deleteApplication**](ApplicationsApi.md#deleteApplication) | **DELETE** /api/v1/workspaces/{workspace_id}/applications/{application_id} | 
...
> Object deleteApplication(workspaceId, applicationId)
...
apiInstance.deleteApplication(workspaceId, applicationId).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
